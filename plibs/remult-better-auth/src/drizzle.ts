import { type SQL, and, asc, count, desc, eq, gt, gte, inArray, like, lt, lte, ne, or, sql } from "drizzle-orm"
...
export const drizzleAdapter = (db: DB, config: DrizzleAdapterConfig) =>
	createAdapter({
		...
		adapter: ({ getFieldName, debugLog }) => {
			...
			const withReturning = async (model: string, builder: any, data: Record<string, any>, where?: Where[]) => {
